...
//create variable totalAcres to save the number
let totalAcres = 0;

//create a loop to add acres picked in different types of apples
...
//create a while loop to calculate days
while(acresLeft > 0){
    days++;
...
//create three arrays to log the result
let fujiTons = [];
let galaTons = [];
let pinkTons = [];

//create a for loop to push tons of apple per day to the array of different apple types
for(let i = 0; i < fujiAcres.length; i++){
...
//create three variables to store results
let fujiPounds = 0;
let galaPounds = 0;
let pinkPounds = 0;

//create a for loop to calculate total pounds of apples per type
...
//store the total profit after calculating using: pounds * price
...
//calculate the total profits by adding up profits of three apple types
